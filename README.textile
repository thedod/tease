...
Tease does not _automatically_ aggregate feeds _for_ you, but rather lets you _manually_ aggregate information _with_ it. It's serves a similar function to the home-page / section-page editors you have at large cms systems (only without the large cms system itself).
